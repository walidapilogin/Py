...
class Proxy:
    ...
    def udp_server(self):
        ...
        #----<<<Command>>>---- 
            ...
            if b"/fakefr" in data:  #OP9
                ...
                self.spam_ip_39698.send(b'\x06\x00\x00\x00{\x08\xd4\xd7\xfa\xba\x1d\x10\x06 \x02*o\x08\x81\x80\x83\xb6\x01\x1a)[f50057]\xd8\xb5\xd8\xa7\xd8\xa6\xd8\xaf\xe3\x85\xa4\xd8\xa7\xd9\x84\xd8\xa8\xd9\x87\xd8\xa7\xd8\xa6\xd9\x85[f50057]2\x02ME@N\xb0\x01\x13\xb8\x01\xdc)\xd8\x01\xd4\xd8\xd0\xad\x03\xe0\x01\xb2\xdd\x8d\xae\x03\xea\x01\tAO'-'TEAM\xf0\x01\x01\xf8\x01\xdc\x03\x80\x02\xfd\x98\xa8\xdd\x03\x90\x02\x01\xd0\x02\x11\xd8\x02F')
    ...
    def level_up(self ):
        ...
        time.sleep(3)
        print("start")
        self.spam_ip_39698.send(bytes.fromhex("031500000010091eb74eef39b7574e359602b0670ca8"))
        self.spam_ip_39698.send(bytes.fromhex("031500000010091eb74eef39b7574e359602b0670ca8"))
        self.spam_ip_39698.send(bytes.fromhex("031500000010091eb74eef39b7574e359602b0670ca8"))
